...
def parse_args():
  ...
  parser = argparse.ArgumentParser(description='Faster R-CNN text detection demo')
  parser.add_argument('--gpu', dest='gpu_id', help='GPU device id to use [0]',
            default=0, type=int)
  parser.add_argument('--cpu', dest='cpu_mode',
            help='Use CPU mode (overrides --gpu)',
            action='store_true')
  parser.add_argument('--net', dest='demo_net', help='Network prototxt')
  parser.add_argument('--model', dest='trained_model', help='weights')
...
if __name__ == '__main__':
  ...
  args = parse_args()
  prototxt = os.path.join(cfg.ROOT_DIR, '..', args.demo_net)
  caffemodel = os.path.join(cfg.ROOT_DIR, '..', args.trained_model)
